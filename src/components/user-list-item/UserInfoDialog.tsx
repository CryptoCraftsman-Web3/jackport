        ...
        <DialogContent  sx={{padding: 0}}>
            <Grid container 
                ...
                <Grid item>
                    <div className="flex flex-col items-center">
                        ...
                        <div className="flex items-center pt-3">
                            <Typography>{name.slice(0, 3) + "..." + name.slice(-3)}</Typography>
                ...
                <Grid item container direction="column" alignItems="stretch" spacing={1}>
                    <Grid item>
                        <div className="flex justify-between items-center">
                            <Typography fontWeight="800" color={"grey"}>Past Rounds</Typography>
                            <Button endIcon={<OpenInNewIcon />}>View Wallet</Button>
                        </div>
                    </Grid>
                    <Grid item>
                        <Card className="w-100 border" sx={{borderRadius: "20px", borderColor: "#555"}}>
                            <Grid container>
                                {rows.map((row, index) => (
                                    <React.Fragment>
                                        <Grid item xs={12} md padding={2}>
                                            <div className="h-full flex flex-col justify-between">
                                                ...
                                                <div className="flex items-center pt-2">
                                                    <Typography color={"grey"} >{row.category}</Typography>
                ...
                <Grid item container spacing={1}>
                    <Grid item>
                        <Typography fontWeight="800" color={"grey"}>This Round</Typography>
                    </Grid>
                    <Grid item container direction="column" spacing={2}>
                                        ...
                                        <Grid xs={12} md item>
                                            <div>
                                                <div className="flex items-center">
                                                    <SolLogo />
                                                    <Typography variant="h5" px={1}>0.1</Typography>
                                                </div>
                        ...
                        <Grid item container alignItems="center" px={1}>
                            <Grid xs item>
                                <div className="flex items-center">
                                    <SolLogo />
                                    <Typography variant="h5" px={1} >0.1 SOL</Typography>
                                </div>
                            </Grid>
                            <Grid xs item>
